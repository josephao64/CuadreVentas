document.addEventListener("DOMContentLoaded", async () => {
    ...
    window.mostrarCuadre = async (id) => {
        ...
        if (docSnap.exists) {
            ...
            fieldsToLoad.forEach(fieldId => {
                const element = document.getElementById(fieldId);
                if (element) {
                    element.value = data[fieldId.replace(/-/g, '_')] || 0;
                }
            });
    ...
    function updateSistemaTotals() {
        for (let i = 1; i <= 3; i++) {
            ...
            const ventaTotalElement = document.getElementById(`caja${i}-venta-total`);
            if (ventaTotalElement) {
                ventaTotalElement.value = totalVentaSistema.toFixed(2);
            }
        }
    ...
    function updateCajaTotals() {
        for (let i = 1; i <= 3; i++) {
            ...
            const totalEfectivoElement = document.getElementById(`caja${i}-total-efectivo`);
            const totalVentaCajeroElement = document.getElementById(`caja${i}-total-venta-cajero`);
            if (totalEfectivoElement) {
                totalEfectivoElement.value = totalEfectivo.toFixed(2);
            }
            if (totalVentaCajeroElement) {
                totalVentaCajeroElement.value = (totalEfectivo +
    ...
    function updateCuadroDatos() {
        ...
        if (document.getElementById('fecha-hoy')) {
        ...
        if (document.getElementById('venta-efectivo-cuadro')) {
            document.getElementById('venta-efectivo-cuadro').value = totalVentaEfectivo.toFixed(2);
        }
        if (document.getElementById('venta-tarjeta-cuadro')) {
            document.getElementById('venta-tarjeta-cuadro').value = totalVentaTarjeta.toFixed(2);
        }
        if (document.getElementById('motorista-cuadro')) {
            document.getElementById('motorista-cuadro').value = totalMotoristaAdmin.toFixed(2);
        }
        if (document.getElementById('total-cuadro')) {
            document.getElementById('total-cuadro').value = (totalVentaEfectivo + totalMotoristaAdmin + totalVentaTarjeta).toFixed(2);
        }

        const sobrante = (totalEncargado - totalSistema).toFixed(2);
        if (document.getElementById('venta-efectivo-admin')) {
            document.getElementById('venta-efectivo-admin').value = (totalVentaEfectivo + totalMotoristaAdmin).toFixed(2);
        }
        if (document.getElementById('venta-tarjeta-admin')) {
            document.getElementById('venta-tarjeta-admin').value = totalVentaTarjeta.toFixed(2);
        }
        if (document.getElementById('total-efectivo-admin')) {
            document.getElementById('total-efectivo-admin').value = (totalVentaEfectivo + totalMotoristaAdmin).toFixed(2);
        }
        if (document.getElementById('motorista-cuadro-admin')) {
            document.getElementById('motorista-cuadro-admin').value = totalMotoristaAdmin.toFixed(2);
        }
        if (document.getElementById('gastos-cuadro')) {
            document.getElementById('gastos-cuadro').value = (-totalGastos).toFixed(2);
        }
        if (document.getElementById('sobrante-cuadro')) {
            document.getElementById('sobrante-cuadro').value = sobrante;
        }

        const totalADepositar = (parseFloat(document.getElementById('total-efectivo-admin').value) + parseFloat(document.getElementById('venta-tarjeta-admin').value) + parseFloat(document.getElementById('motorista-cuadro-admin').value) + parseFloat(document.getElementById('gastos-cuadro').value) + parseFloat(document.getElementById('sobrante-cuadro').value)).toFixed(2);
        if (document.getElementById('total-depositar-cuadro')) {
            document.getElementById('total-depositar-cuadro').value = totalADepositar;
        }

        if (document.getElementById('diferencia-efectivo-cuadro')) {
            document.getElementById('diferencia-efectivo-cuadro').value = (totalVentaEfectivo - parseFloat(document.getElementById('total-venta-efectivo').value)).toFixed(2);
        }
        if (document.getElementById('diferencia-tarjeta-cuadro')) {
            document.getElementById('diferencia-tarjeta-cuadro').value = (totalVentaTarjeta - parseFloat(document.getElementById('total-venta-tarjeta').value)).toFixed(2);
        }
        if (document.getElementById('diferencia-total-cuadro')) {
            document.getElementById('diferencia-total-cuadro').value = (parseFloat(document.getElementById('diferencia-efectivo-cuadro').value) + parseFloat(document.getElementById('diferencia-tarjeta-cuadro').value)).toFixed(2);
        }
    }
